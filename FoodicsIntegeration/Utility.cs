...
namespace FoodicsIntegeration
{
   
    public class Utility
    {
        public static RestRequest GenerateResetRequest(string EntityName, Method methodobj)
        {
            var client = new RestClient(ConfigurationManager.AppSettings["Foodics.ResetURL"] + EntityName);
            client.Timeout = -1;
            var request = new RestRequest(methodobj);
